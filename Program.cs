    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            PrintLinesInCenter("Coaching by Edward", "***********************", "  &&&     &&&  ", " &**&     &**& ", "&***&|||||&***&", " &**&     &**& ", "  &&&     &&&  ", "", "Press enter to begin");
                ...
                while (string.IsNullOrEmpty(workOutType))
                {
                ...
                PrintLinesInCenter($"What are your goals {firstName}?", "", "Please choose for Endurance, Hypertrophy, or Strength.", "Please choose an option listed above: ", "");
        ...
        #region Decoration LinesinCenter
        public static void PrintLinesInCenter(params string[] lines)
        {
            int verticalStart = (Console.WindowHeight - lines.Length) / 2; // works out where to start printing the lines
